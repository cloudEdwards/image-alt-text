...
app.get('/promise', function (req, res) {
  ...
  promise.then(function(result) {
    ...
    for (var i = 0; obj_array.length > i; i++) {  
        console.log("??");
        // console.log(obj_array[i]);
        console.log(Annotations.getAltText(obj_array[i]));
    };
  });
});
